...
| Feature                      | Replicated       | Apollo          | Octopus Deploy  | Glasskube Cloud |
|------------------------------|------------------|-----------------|-----------------|-----------------|
| Deployment Method            | Pull             | Push            | Push            | Pull            |
| Vendor Platform for Managing Releases | Yes       | Yes             | Yes             | Yes             |
| CI / CD Integration (Planned for Glasskube) | Yes | Yes              | Yes              | Planned             |
| Customer Portal              | Yes             | No              | No              | Yes             |
| Docker Support               | Yes             | Yes             | Yes             | Yes             |
| Helm Support                 | Yes             | Yes              | Yes              | Yes             |
| On Premises Support          | No             | No              | No             | Yes             |
| Application Management       | Yes             | Yes              | Yes             | Yes             |
| Customer Management          | Yes             | Yes              | Yes             | Yes             |
| Deployment Management        | Yes             | Yes             | Yes             | Yes             |
