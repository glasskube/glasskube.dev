...
![thumbnail](https://app.distr.sh/distr-logo.svg)
...
Additionally, we some graphs on the dashboard visualize the uptime of deployment targets over time.
To be quite frank, our users didn't mind having these components on our old dashboard, but also they didn't find them useful.

IMAGE (dashboard old)

With the recent [introduction of our container registry](/blog/distr-registry/) we are now also supporting
...
Modern applications consist of multiple application components which might want to be deployed interdependently of each other,
...
<Tabs groupId="frontend-build">
  <TabItem value="new" label="latest dashboard">
```shell
...
```
  ...
  <TabItem value="old" label="old dashboard">
```shell
...
We are very excited about this new dashboard and hope you also like what be built.
If you have any other feedback, please let us know!


<DefaultCTA />

P.S.: Read all our announcements of this weeks launch week here: [`#distr-launch-week`](/blog/tags/distr-launch-week/)
