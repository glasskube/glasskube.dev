...
import {signupLink} from '@site/src/components/buttons/SignupForWaitlistButton.tsx';
...
<div style={{'text-align': 'center'}}>
  ![Meme about deploying a container on
  Kubernetes](/img/blog/2025-05-20-distr-docker-swarm/kubernetes-meme.jpg)
</div>
