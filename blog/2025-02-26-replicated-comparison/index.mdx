...
[Distr](https://distr.sh/) and [Replicated](https://www.replicated.com/) are software delivery platforms that help software vendors
...
Software delivery platforms primarily serve **independent software vendors ([ISVs](/glossary/isv-meaning/))**.
...
The best software delivery platforms make this connection as smooth and frictionless as possible, keeping both parties' needs in mind.

- **Independent Software Vendors:** These are the primary users of software delivery platforms.
...
They interact with software delivery platforms indirectly and if done well, they need not even know they are interacting with one at all.
...
For more detailed information on Replicated’s pricing tiers, visit their official site at [replicated.com](https://www.replicated.com/pricing)
...
and in a position to make the most out of the platform as soon as possible.
...
You can use Distr solely as an artifact management registry with built-in vulnerability scanning, and distribute specific tags to specfic customers.
