...
## Prerequisites
Distr is designed to help distribute "on-prem" ready software to [customer-controlled environments](/blog/5-ways-to-succeed-without-access-to-customer-environments/). The key phrase here is ["on-prem ready"](/white-paper/building-blocks/).
...
:::info
The Onboarding Wizard also offers the option to onboard a sample app for testing purposes. To gain a better understanding of how Distr works, we'll begin by onboarding the [test app](https://github.com/go-shiori/shiori).
:::
