...
:::info 
To get started with the self-hosted option, create your [account](https://distr.sh/) on Distr first and then follow our [guide](/products/cloud/docs/guides/how-to-self-host-distr/) to deploy Distr in your environment.
:::