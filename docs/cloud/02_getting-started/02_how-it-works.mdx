...
[Distr](https://distr.sh/) is a comprehensive platform available both as a [SaaS](/glossary/saas-definition/) solution and as a fully [self-hostable](/glossary/self-managed-software/) option. It allows ISVs to deliver their applications to on-premises customers through a centralized platform. This platform enables end customers to access available application versions and maintain control over when and where installations are deployed.
...
The Distr platform was designed with [ISVs in mind](/blog/5-ways-to-succeed-without-access-to-customer-environments/), prioritizing their success by ensuring end customers are satisfied. To achieve this, the platform includes two distinct control consoles.
