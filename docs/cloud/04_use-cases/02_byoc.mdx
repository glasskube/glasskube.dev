...
[BYOC](/glossary/byoc-definition/) deployments involve delivering commercial software to environments where the ISV has some level of shared responsibility or permission to access and manage the customer-owned target deployment environment.
...
The key distinction between [BYOC and on-prem deployments](/blog/replicated-vs-apollo-vs-octopus-deploy-vs-glasskube-cloud/#the-key-differentiator-push-vs-pull-deployments) is the approach to software updates. In BYOC scenarios, updates can be both pulled by the end customer and pushed directly by the ISV. This added flexibility simplifies update management for customers who may prefer or require additional support.
